...
def main_menu_keyboard() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="📊 דוח ביצועים", callback_data="menu:report"),
        ...
        [InlineKeyboardButton(text="📋 אדסטים", callback_data="menu:adsets"),
         InlineKeyboardButton(text="➕ צור קמפיין", callback_data="menu:create_campaign")],
...
def objectives_keyboard() -> InlineKeyboardMarkup:
    ...
    buttons = [[InlineKeyboardButton(text=label, callback_data=f"create:objective:{val}")]
               for label, val in objectives]
